...
<section id="main-content">
 ...
 <div class="form-group" style="display:none;">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="mobile" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" maxlength="11">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="note2" readonly>
  </div>
  <div class="form-group">
...
function saveData() {
  ...
  if(!cnf){
    ...
    if(mobile.length != 11) {
      alert("Mobile Number requires 11 Digits");
      return;
    }
    ...
    if(addSalaryHiddenInput > 0){
      ...
      for(i=0; i<addSalaryHiddenInput; i++) {
        ...
        if(priceVal != '' && sizeVal != 'None' && typeVal != 'None' && productVal != 'None' && finishingVal != 'None') {
          size[inc] = sizeVal;
    ...
    let quotationId = -1; // -1 denote the quotation is sent directly
    ...
    $.ajax({
       ...
       success: function (response) {
        ...
        // window.open('viewQuotationPDF.php');
        // window.open('sunmac_quatation_save.php','_blank');
       }
    });
}
  }
