...
$sql = "SELECT S.SAMPLE_PI_ID, S.REFERENCE_NO, S.CUSTOMER_NAME, S.MOBILE, S.DATE, (S.TOTAL_AMOUNT - S.GST_AMOUNT) AS PRODUCT_AMOUNT, S.TOTAL_AMOUNT, S.GST_AMOUNT, 
        ...
        AND TB.SHOW_TO_ACCOUNTS = 0 
        GROUP BY T.SAMPLE_PI_ID
        ORDER BY S.SAMPLE_PI_ID DESC
        ";
...
?>
  ...
  <!DOCTYPE html>
  <head>
  <title>Settled Accounts View</title>
