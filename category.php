                      ...
                      <form action="category_php.php" method="post" role="form"  enctype="multipart/form-data">
                         ...
                         <input type="hidden" name="PRODUCT_ID" id="PRODUCT_ID" value="<?php echo $cateId; ?>" >
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="file" class="form-control" id="image" name="PRODUCT_IMAGE" accept="image/JPEG" >
                                  </div>
                                  ...
                                  <input type="Submit" class="btn btn-info" id="Submit_button" value="Submit" onclick="saveMachineDetails()" name="submit">  
      ...
      $('td', this).each(function(index, val){
        ...
        if(index == 0) {
          console.log("INDEX : ", index, "VALUE : ", val);
            demo.push(val.innerText);
        }  
      });
    });
   
      // if( demo.indexOf(dropDown.value) == -1 ) {
      //       alert('Machine is already selected.');
      //       dropDown.value = "0";
      //       return false;
      //     }
