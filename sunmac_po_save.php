...
if (isset($_GET['invoiceId'])) {
	$invoiceDetails = "SELECT * FROM sample_po WHERE SAMPLE_PO_ID=" . $_GET['invoiceId'];
	...
	$sql = "SELECT * FROM sample_po_details WHERE SAMPLE_PO_ID=" . $_GET['invoiceId'];
	$result = mysqli_query($conn, $sql);

	$sql1 = "SELECT TOTAL_AMOUNT, (TOTAL_AMOUNT-GST_AMOUNT) as tot, (gst / 2) as gst, (GST_AMOUNT / 2) as gst_amt FROM sample_po WHERE SAMPLE_PO_ID=" . $_GET['invoiceId'];
		...
		<section id="main-content">
			<section class="wrapper">
				<div class="form-w3layouts">
					...
					<button type="button" name="button" class="btn btn-default pull-right" onclick="location.href = 'viewPO.php';">
							...
							<section class="panel">
								...
								<div class="row m-1">
									...
									<div class="col-sm-6">
										<div class="row">
											<div class="col-xs-6">
												<b>PO.NO: </b><?php echo $referenceNo; ?></br>
											</div>
											<div class="col-xs-6">
												&nbsp;</br>
											</div>
