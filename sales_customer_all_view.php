            ...
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading">
                        CUSTOMER VIEW
                        <A HREF="sales_customer_all.php"><button style="float: right;margin-top: 12px" type="button" class="btn btn-danger">BACK</button></A>
                    </header>
...
var productName = [];
                          ...
                          <input disabled type="text" class="form-control" value="<?php echo $fetched_row['S_NAME']; ?>" id="S_NAME" required >
                                ...
                                <div class="form-group">
                                    ...
                                    <input disabled type="text" class="form-control" value="<?php echo $fetched_row['S_MOBILE']; ?>" id="S_MOBILE" required >
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input disabled type="text" class="form-control" value="<?php echo $fetched_row['S_MAIL']; ?>" id="S_MAIL" required >
                                </div>
                                      
                                  <div class="form-group">
                                    <label for="mail">Customer Address</label>
                                    <input disabled type="text" class="form-control" value="<?php echo $fetched_row['S_ADDRESS']; ?>" id="S_ADDRESS" required >
                                  </div>
...
?>
                                <div class="form-group">
                                    ...
                                    <select disabled type="text" class="form-control" id="S_CITY" name="S_CITY">
