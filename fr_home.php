...
<body>
                                            ...
                                            <div id="from-to-date-div">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="month" class="form-control" id="from-date-input">
                                                    </div>
                                                </div>
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        <label for="usr">To Date:</label>
                                                        <input type="month" class="form-control" id="to-date-input">
                                                    </div>
                                                </div>
                                                <div class="col-sm-2">&nbsp;</div>
                                            </div>
    ...
    <script>
        ...
        var showReport = function() {
            ...
            toDate = toDate + "-" + lastday(toDate.split("-")[0], toDate.split("-")[1]);
            let canShowReport = validate(fromDate, toDate);
            if (canShowReport) {
                window.location.replace("fr_report.php?fromDate=" + fromDate + "&toDate=" + toDate);
            } else {
                return false;
            }
        };
