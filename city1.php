...
if(isset($_POST['submit'])){
    ...
    mysqli_query($conn, "DELETE FROM `city` WHERE lower(CITY_NAME) = lower('$CITY_NAME')");
if (mysqli_query($conn, "INSERT INTO `city` (CITY_NAME) VALUES ('$CITY_NAME')")) {
?>
            <script type="text/javascript">
            alert('Data Are Inserted Successfully');
            window.location.href='city1.php';
            </script>      
    <?php
        } else {
                    ...
                    <div class="panel-body">
                        <div class="position-center">
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="city" placeholder="Enter Location" name="CITY_NAME">
                                </div>
