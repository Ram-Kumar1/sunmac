...
if (isset($_GET['type'])) {
    ...
    $resultQuery = "SELECT C.PRODUCT_NAME, PS.SIZE, PS.thickness, PS.STOCK_VALUE FROM product_stock PS, category C WHERE 1=1 AND PS.PRODUCT_ID = C.PRODUCT_ID AND PS.TYPE = '$type' ORDER BY C.PRODUCT_NAME, PS.SIZE, PS.thickness";
    ...
    if ($resultQueryProcess = mysqli_query($conn, $resultQuery)) {
        while ($row = mysqli_fetch_array($resultQueryProcess)) {
            ...
            $data['SIZE'] = $row['SIZE'];
            $data["THISCKNESS"] = $row['thickness'];
            $data['STOCK'] = $row['STOCK_VALUE'];
                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading">
                                Report
                                <button type="button" class="btn btn-primary pull-left" onclick="location.href = 'production_flow_report.php';" style="margin: 0.5em;">
                          ...
                          PDF
                                ...
                                <button type="button" class="btn btn-success pull-right" id="excelBtn" style="margin: 0.5em;">
