...
var productName = [];
                          ...
                          <input type="text" class="form-control" value="<?php echo $fetched_row['S_NAME']; ?>" id="S_NAME" disabled >
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $fetched_row['S_MOBILE']; ?>" id="S_MOBILE" disabled >
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $fetched_row['S_MAIL']; ?>" id="S_MAIL" disabled >
                                </div>
                                      
                                  <div class="form-group">
                                    <label for="mail">Customer Address</label>
                                    <input type="text" class="form-control" value="<?php echo $fetched_row['S_ADDRESS']; ?>" id="S_ADDRESS" disabled >
                                  </div>
...
?>
                                <div class="form-group">
                                    ...
                                    <select type="text" class="form-control" id="S_CITY" name="S_CITY" disabled>
...
debugger;
      ...
      $.ajax({
       ...
       window.location.href = "ass_new_product_cust.php"
       }
       });
  ...
  var checkRadioButton = function() {
    if(manufArray && manufArray.length > 0) {
      for(let i=0; i<manufArray.length; i++) {
        let nameOfRadio = $('input[type="radio"][value="' + manufArray[i] + '_Manufacturer"]').attr('name');
        $('input[type="radio"][value="' + manufArray[i] + '_Manufacturer"]').prop("checked", true);
        $('input[type="radio"][name="'+nameOfRadio+'"]').attr('disabled',true);
      }
    }
    
    if(dealerArray && dealerArray.length > 0) {
      for(let j=0; j<dealerArray.length; j++) {
        let nameOfRadio = $('input[type="radio"][value="' + dealerArray[j] + '_Dealer"]').attr('name');
